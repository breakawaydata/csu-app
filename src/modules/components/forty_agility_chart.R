  ...
  tagList(
    lapply(seq_len(length(state$active)), function(index) {
      tags$style(glue::glue('
        ...
        #{ns("forty_wrapper")} [data-part="section"][data-group="{state$active[index]}"] rect
...
ui <- function(id, options) {
  ...
  gridPanel(
    ...
    areas = c(
      ...
      "...         body  body  body  body  body ...",
      "left_lower  body  body  body  body  body right_lower",
      "...         body  body  body  body  body ...",
      "left_lowest body  body  body  body  body right_lowest"
    ),
    ...
    div(
      ...
      htmltools::htmlTemplate(
        "modules/templates/reach_double_graphic.svg"
      ),
    ...
    stat_wrapper("in_out", "right", "upper", uiOutput(ns("right_top")), options$labels$right$top),
...
speedagilityChart <- R6Class("speedagilityChart",
  public = list(
...
speedagilityChart <- speedagilityChart$new
